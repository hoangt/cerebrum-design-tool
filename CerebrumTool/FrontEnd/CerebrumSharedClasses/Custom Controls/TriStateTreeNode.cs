...
namespace SmartSolutions.Controls
{
	...
	public class TriStateTreeNode : TreeNode
	{
        ...
        /// <summary>
        /// Creates a new TriStateTreeNode with the specified text.
        /// </summary>
        /// <param name="text">The text to display on the node.</param>
		public TriStateTreeNode( string text ) : base( text ) {}
        /// <summary>
        /// Creates a new TriStateTreeNode with the specified text, and using the specified ImageIndex and selectedImageIndex for display.
        /// </summary>
        /// <param name="text">The text to display on the node.</param>
        /// <param name="imageIndex">The ImageIndex to be used for the node.</param>
        /// <param name="selectedImageIndex">The SelectedImageIndex to be used for the node.</param>
        public TriStateTreeNode(string text, int imageIndex, int selectedImageIndex) : base(text, imageIndex, selectedImageIndex) { }
        /// <summary>
        /// Creates a new TriStateTreeNode with the specified text, and using the specified ImageIndex and selectedImageIndex for display, as well as attaching the specified children to it.
        /// </summary>
        /// <param name="text">The text to display on the node.</param>
        /// <param name="imageIndex">The ImageIndex to be used for the node.</param>
        /// <param name="selectedImageIndex">The SelectedImageIndex to be used for the node.</param>
        /// <param name="children">The array of children to be attached to the new node.</param>
        ...
        /// <summary>
        /// Creates a new TriStateTreeNode with the specified text as well as attaching the specified children to it.
        /// </summary>
        /// <param name="text">The text to display on the node.</param>
        /// <param name="children">The array of children to be attached to the new node.</param>
        ...
        /// <summary>
        /// Get / Set whether the checkbox is visible for this node.
        /// </summary>
