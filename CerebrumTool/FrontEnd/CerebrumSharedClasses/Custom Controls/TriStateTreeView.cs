...
namespace SmartSolutions.Controls
{
	...
	public class TriStateTreeView : TreeView
	{
        ...
        /// <summary>
        /// Get / Set whether the TriStateTreeView will use custom images for its nodes
        /// </summary>
		[Category( "CheckState" )]
		[DefaultValue(false)]
        ...
        /// <summary>
        /// Get / Set the ImageIndex to be used for TriStateTreeNodes in the 'Checked' State
        /// </summary>
		[Category( "CheckState" )]
        ...
        /// <summary>
        /// Get / Set the ImageIndex to be used for TriStateTreeNodes in the 'Unchecked' State
        /// </summary>
		[Category( "CheckState" )]
		[TypeConverter(typeof(TreeViewImageIndexConverter))]
		[Editor( "System.Windows.Forms.Design.ImageIndexEditor, System.Design, Version=1.0.5000.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        /// <summary>
        /// Get / Set the ImageIndex to be used for TriStateTreeNodes in the 'Indeterminate' State
        /// </summary>
		[Category( "CheckState" )]
		[TypeConverter(typeof(TreeViewImageIndexConverter))]
		[Editor( "System.Windows.Forms.Design.ImageIndexEditor, System.Design, Version=1.0.5000.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
		...
		private int HandleNotify( Message msg )
		{
			...
			{
                CerebrumSharedClasses.ErrorReporting.DebugException(ex);
			}
		...
		private void PaintTreeNode( TriStateTreeNode node, Graphics gx )
		{
			if( this.CheckBoxes )
			{
                ...
                Rectangle ncRect = new Rectangle(node.Bounds.X - 13, node.Bounds.Y + 1, 13, 13);
				...
				if( node.CheckboxVisible )
				{
					...
					switch( node.CheckState )
					{
						...
						case CheckState.Indeterminate:		// Pushed
                            ...
                            Rectangle gRect = new Rectangle(node.Bounds.X - 10, node.Bounds.Y + 4, 7, 7);
                            gx.FillRectangle(new SolidBrush(Color.Gray), gRect);
							break;
					}
				}
			}
		...
		/// <summary>
		/// Draws the node lines before the checkboxes are drawn
        /// </summary>
        /// <param name="node">The tree node to draw lines for</param>
        /// <param name="bounds">The bounding box used to define the borders of the line drawing</param>
        ...
        /// <summary>
        /// Raises the System.Forms.TreeView.AfterSelect event.
        /// </summary>
		...
		/// <summary>
		/// Toggles node state between checked and unchecked
		/// </summary>
		/// <param name="node"></param>
