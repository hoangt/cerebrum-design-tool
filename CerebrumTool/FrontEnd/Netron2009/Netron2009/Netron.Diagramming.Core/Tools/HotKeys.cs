        ...
        public void KeyUp(System.Windows.Forms.KeyEventArgs e)
        {
            ...
            switch (e.KeyCode)
            {
                case System.Windows.Forms.Keys.A:
                    // Disable built-in select all command
                    //if (controlIsPressed)
                    //{
                ...
                case System.Windows.Forms.Keys.N:
                    // Disable built-in new document command
                    //if (controlIsPressed)
                ...
                case System.Windows.Forms.Keys.V:
                    // Disable built-in paste command
                    //if (controlIsPressed)
                    //{
                    //    this.Controller.ActivateTool(
