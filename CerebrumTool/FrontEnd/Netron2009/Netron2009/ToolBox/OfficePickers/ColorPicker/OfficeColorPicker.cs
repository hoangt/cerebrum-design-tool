...
namespace ToolBox.OfficePickers
{
    ...
    ToolboxItem(true) ,
  ToolboxBitmap(typeof(OfficeColorPicker), "ColorPicker.OfficeColorPicker"),
    ...
    public partial class OfficeColorPicker : UserControl
    {
       ...
       DefaultValue(typeof(Color), "System.Drawing.Color.Black")]
        ...
        public string LineWeightName
        {
            get
            {
                string widthName = "Custom weight";
                if (mCurrentSelected > -1 &&
                    mCurrentSelected < CustomColors.SelectableColorsNames.Length)
                {
                    widthName = CustomColors.SelectableColorsNames[mCurrentSelected] + " px";
                }
                return widthName;
        ...
        public void Show(Point startLocation)
        {
            ...
            mContextForm.Height = OfficeColorPicker.PreferredHeight;
            mContextForm.Show(this, startLocation, OfficeColorPicker.PreferredWidth);
        }
        /// <summary>
        /// Opens the control inside a context menu in the specified location
        /// </summary>
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            for (int recIndex = 0; recIndex < buttons.Length; recIndex++)
            {
                ...
                if (buttons[recIndex].Contains(e.Location))
                {
                    ...
                    lineWidthTip.SetToolTip(this, CustomColors.SelectableColorsNames[recIndex]);
                }
            }
            this.Refresh();
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            for (int colorIndex = 0; colorIndex < colors.Length; colorIndex++)
            {
                ...
                bool hotTrack = colorIndex == mCurrentHotTrack;
                bool selected = colorIndex == mCurrentSelected;
        ...
        protected void PaintMoreColorsButton(Graphics graphics, int x, int y)
        {
            ...
            bool selected = mCurrentSelected == 40;
            bool hotTrack = mCurrentHotTrack == 40;
