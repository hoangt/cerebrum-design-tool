...
namespace ToolBox.OfficePickers
{
    ...
    public class ToolStripLineCapPicker : ToolStripDropDownButton
    {
        ...
        {
            mLineCapPicker.SelectedCapChanged += 
                new EventHandler(HandleSelectedColorChanged);
            this.AutoSize = false;
        ...
        // ------------------------------------------------------------------
        /// <summary>
        /// Returns the current left (or starting) LineCap selected.
        /// </summary>
        /// <returns>LineCap</returns>
        // ------------------------------------------------------------------
        public LineCap GetLeftCap()
        {
            switch (this.LineCap)
            {
        ...
        // ------------------------------------------------------------------
        /// <summary>
        /// Returns the current end (or right) LineCap selected.
        /// </summary>
        /// <returns>LineCap</returns>
        // ------------------------------------------------------------------
        public LineCap GetEndCap()
        {
            switch (this.LineCap)
            {
                ...
                case ConnectionCap.SquareBoth:
                    return System.Drawing.Drawing2D.LineCap.SquareAnchor;
                case ConnectionCap.Generalization:
                    return System.Drawing.Drawing2D.LineCap.Custom;
                default:
                    return System.Drawing.Drawing2D.LineCap.NoAnchor;
            }
        }
