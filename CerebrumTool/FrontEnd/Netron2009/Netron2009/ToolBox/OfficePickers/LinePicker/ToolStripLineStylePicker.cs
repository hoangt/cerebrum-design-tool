...
namespace ToolBox.OfficePickers
{
    ...
    /// </summary>
    [DefaultEvent("SelectedStyleChanged"), DefaultProperty("LineStyle"), 
    Description("ToolStripItem that allows selecting a style from a style picker control."),
    ToolboxItem(false),
    ToolboxBitmap(typeof(ToolStripLineStylePicker), "LinePickers.ToolStripLineStylePicker")]
    public class ToolStripLineStylePicker : ToolStripDropDownButton
    {
        ...
        /// </summary>
        [Category("Behavior"),
       Description("Occurs when the value of the DashStyle property changes.")]
        ...
        {
            get { return mLineStylePicker.LineStyle; }
            set 
            { 
                mLineStylePicker.LineStyle = value;
                Refresh();
        ...
        new public string ToolTipText
        {
            ...
            set 
            {
                ...
                {
                    base.ToolTipText =  mLineStylePicker.LineStyle.ToString()  ;
                }
                else
                {
        ...
        /// </summary>
        private OfficeLineStylePicker mLineStylePicker = new OfficeLineStylePicker();
        /// <summary>
        ...
        #region Ctor
        /// <summary>
        /// Initializes a new instance of the ToolStripLineStylePicker that holds
        /// OfficeColorPicker control inside a ToolStripItem to add to ToolStrip containers.
        /// </summary>
        public ToolStripLineStylePicker() : base()
        {
            InitControl();
        }
        ...
        public ToolStripLineStylePicker(DashStyle startingStyle)
            : base()
        {
            LineStyle = startingStyle;
            InitControl();
        }
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            {
                components.Dispose();
                if (!mLineStylePicker.IsDisposed)
                    mLineStylePicker.Dispose();
            }
        ...
        {
            mLineStylePicker.SelectedStyleChanged += new EventHandler(HandleSelectedColorChanged);
            this.AutoSize = false;
        ...
        protected override void OnClick(EventArgs e)
        {
            ...
            mLineStylePicker.Show(startPoint);
            base.OnClick(e);
        }
