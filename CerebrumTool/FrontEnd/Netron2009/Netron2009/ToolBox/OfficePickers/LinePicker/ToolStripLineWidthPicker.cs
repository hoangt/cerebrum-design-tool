...
namespace ToolBox.OfficePickers
{
    ...
    /// </summary>
    [DefaultEvent("SelectedWidthChanged"), DefaultProperty("Width"), 
    Description("ToolStripItem that allows selecting a color from a color picker control."),
    ToolboxItem(false),
    ToolboxBitmap(typeof(ToolStripLineWidthPicker), "LinePickers.ToolStripLineWidthPicker")]
    public class ToolStripLineWidthPicker : ToolStripDropDownButton
    {
        ...
        {
            get { return mLineWidthPicker.LineWidth; }
            set 
            { 
                mLineWidthPicker.LineWidth = value;
                Refresh();
        ...
        new public string ToolTipText
        {
            ...
            set 
            {
                ...
                {
                    base.ToolTipText =  mLineWidthPicker.LineWeightName  ;
                }
                else
                {
        ...
        /// </summary>
        private OfficeLineWidthPicker mLineWidthPicker = new OfficeLineWidthPicker();
        /// <summary>
        ...
        #region Ctor
        /// <summary>
        /// Initializes a new instance of the ToolStripLineWidthPicker that holds
        /// OfficeColorPicker control inside a ToolStripItem to add to ToolStrip containers.
        /// </summary>
        public ToolStripLineWidthPicker() : base()
        {
            InitControl();
        }
        ...
        public ToolStripLineWidthPicker(float startingWidth)
            : base()
        {
        ...
        {
            mLineWidthPicker.SelectedWidthChanged += new EventHandler(HandleSelectedColorChanged);
            this.AutoSize = false;
            this.Width = 30;            
        }
        /// <summary>
        ...
        private void PaintUnderLine(Graphics g)
        {
            ...
            using (Pen pen = new Pen(mLineColor,Math.Min(this.LineWidth, 5F)))
            {
