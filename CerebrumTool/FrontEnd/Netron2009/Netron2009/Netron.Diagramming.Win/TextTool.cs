...
{
    /// <summary>
    /// Tool to draw a TextOnly shape on the canvas.
    ...
    class TextTool : AbstractDrawingTool
    {
        ...
        /// <summary>
        /// This method will be called when the user has finished drawing 
        /// a ghost rectangle or bundle and initiates the actual creation 
        /// of a bundle and the addition to the model via the appropriate 
        /// command.
        /// </summary>
