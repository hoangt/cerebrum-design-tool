 ...
 ********************************************************************/
/******************************************************************** 
 * VortexBridgeAttachment.cs
 * Name: Matthew Cotter
 * Date:  2 Feb 2010 
 * Description: Implementation of IVortexBridgeAttachment as a Vortex-to-Vortex bridge 'end-cap'
 * History: 
 * >> ( 2 Feb 2011) Matthew Cotter: Defined implementation of IVortexBridgeAttachment interface corresponding to the current version of Vortex Router
...
{
    /// <summary>
    /// Implementation of IVortexBridgeAttachment interface to represent a Vortex Bridge Attachment object, by emulating an SOP.
    /// </summary>
    public class VortexBridgeAttachment : IVortexBridgeAttachment
    {
        ...
        /// <summary>
        /// Default constructor.  Creates an unattached Bridge Attachment with an NIF
        /// </summary>
        public VortexBridgeAttachment()
        {
            this._Port = -1;
            this._TDA = -1;
        ...
        #region Properties
        /// <summary>
        /// Core Type name of the Bridge Attachment
        /// </summary>
        public string Type 
        {
            get
        ...
        /// <summary>
        /// Native Core Instance name of the Bridge Attachment
        /// </summary>
        public string CoreInstance { get; set; }
        /// <summary>
        /// Instance name of the Bridge Attachment
        /// </summary>
        ...
        /// <summary>
        /// Version Info of the Bridge Attachment
        /// </summary>
        ...
        /// <summary>
        /// Get the IVortexBridge of which this attachment is a part.
        /// </summary>
        public IVortexBridge Bridge { get; set; }
