...
namespace Netron.Diagramming.Win
{
    ...
    public class View : ViewBase
    {
        ...
        // ------------------------------------------------------------------
        /// <summary>
        /// If the current Ghost is not null, the ghost's area is inflated
        /// (not permanently) by Size(20, 20) and invalidated.  This is
        /// needed when needing to clear an *old* ghost's area before drawing
        /// a new one.
        /// </summary>
        // ------------------------------------------------------------------
        ...
        // ------------------------------------------------------------------
        /// <summary>
        /// If the current Tracker is not null, the Tracker's area is inflated
        /// (not permanently) by Size(20, 20) and invalidated.  This is
        /// needed when needing to clear an *old* Tracker's area before drawing
        /// a new one.
        /// </summary>
        // ------------------------------------------------------------------
        ...
        // ------------------------------------------------------------------
        /// <summary>
        /// If the current Ants is not null, the Ants's area is inflated
        /// (not permanently) by Size(20, 20) and invalidated.  This is
        /// needed when needing to clear an *old* Ants's area before drawing
        /// a new one.
        /// </summary>
        // ------------------------------------------------------------------
