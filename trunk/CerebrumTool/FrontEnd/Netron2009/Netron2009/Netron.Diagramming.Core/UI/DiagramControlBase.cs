...
namespace Netron.Diagramming.Core
{
    ...
    /// </summary>
    [ ToolboxItem(false)   ]
    public abstract class DiagramControlBase : 
        ScrollableControl, 
        ISupportInitialize, 
        IDiagramControl 
    {
        ...
        /// </summary>
        /// <value><c>true</c> to show the grid; otherwise, <c>false</c>.</value>
        [Browsable(true), Description("Gets or sets whether to show the grid.")]
        public bool ShowGrid
        {
            get { return View.ShowGrid; }
            set { View.ShowGrid = value; }
        }
